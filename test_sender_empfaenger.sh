...
SMALL_BINARY_FILE=/usr/local/etc/small_binary_file.bin
SMALL_TEXT_FILE=/usr/local/etc/small_text_file.txt
HUGE_BINARY_FILE=/usr/local/etc/huge_binary_file.bin
